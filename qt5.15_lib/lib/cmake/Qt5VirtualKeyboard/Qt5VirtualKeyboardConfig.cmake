...
function(_qt5_VirtualKeyboard_process_prl_file prl_file_location Configuration lib_deps link_flags)
    ...
    set(_qt5_install_libs "${_qt5VirtualKeyboard_install_prefix}/lib/")
            ...
            elseif(_framework_flag OR _flag MATCHES "^-l(.*)$")
                ...
                elseif(_lib MATCHES "^pthread$")
                    ...
                    if(current_search_paths)
                        find_library(_Qt5VirtualKeyboard_${Configuration}_${_lib}_PATH ${_lib} HINTS ${current_search_paths} NO_DEFAULT_PATH)
                    endif()
                    find_library(_Qt5VirtualKeyboard_${Configuration}_${_lib}_PATH ${_lib} HINTS ${CMAKE_CXX_IMPLICIT_LINK_DIRECTORIES})
...
macro(_populate_VirtualKeyboard_target_properties Configuration LIB_LOCATION IMPLIB_LOCATION
    ...
    set(_static_link_flags "${_Qt5VirtualKeyboard_STATIC_${Configuration}_LINK_FLAGS}")
    if(_static_link_flags)
        set(_static_link_flags_genex "$<${_genex_condition}:${_static_link_flags}>")
        if(NOT CMAKE_VERSION VERSION_LESS "3.13")
            set_property(TARGET Qt5::VirtualKeyboard APPEND PROPERTY INTERFACE_LINK_OPTIONS
...
if (NOT TARGET Qt5::VirtualKeyboard)
    ...
    if(NOT Qt5_EXCLUDE_STATIC_DEPENDENCIES)
        ...
        _qt5_VirtualKeyboard_process_prl_file(
            "${_qt5VirtualKeyboard_install_prefix}/lib/libQt5VirtualKeyboard.prl" RELEASE
    ...
    _populate_VirtualKeyboard_target_properties(RELEASE "libQt5VirtualKeyboard.a" "" FALSE)
